  ...
  - Theme-Classes: block-mt bg-snow
    ...
    Media:
      - Layout-Classes: align-content-center col-sm-8 col-md-4 col-lg-4 mb-4
        ...
        Figcaption: Hypothesis 1 – Original experience. Single entry point to Videos of the Day with rotating images from within the package and with video count.

      - Layout-Classes: align-content-center col-sm-8 col-md-4 col-lg-4 mb-4
        Image: /assets/images/news-stream-promo/00_NewStoriesPromo_first_versions.gif
        Image-Classes: border-bottom border-secondary border-w-2
        Figcaption-top: Hypothesis 2
        Figcaption: Hypothesis 2 – Single entry point to BBC Stories promo with roating images and headlines from within the package of videos.
    ...
    Description-Post-Media:
      - Layout-Classes: offset-md-0 offset-lg-2 col-sm-12 col-md-10 col-lg-8 block-mb
        Paragraph: |
